...
export const FALLBACK_RELICS = [
  ...
  { id: 'steady_hand',        name: 'Steady Hand',         description: 'Dice that land without hitting anything deal +4 bonus effect.',    rarity: 'uncommon', trigger: 'PASSIVE',           effect: 'CLEAN_LAND_BONUS',  value: 4,    color: '#f0c040', synergies: ['phantom', 'anchor_brand'] },
